  ...
  return (
   ...
   <nav className="mb-20 flex items-center justify-between py-6">
    ...
    <div className='m-8 hidden md:flex items-center justify-center gap-4 text-2xl ' >
        <a href='https://www.linkedin.com/in/manishkumar1902/'><FaLinkedin></FaLinkedin></a>
        <a href="https://github.com/ManishMk1"><FaGithub></FaGithub></a>
        <a href=""><FaFacebook /></a>
        <a href="https://x.com/aboutmanishh"><FaSquareXTwitter /></a>
        <a href="https://www.instagram.com/manish_1902/"><FaInstagram /></a>
